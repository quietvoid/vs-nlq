...
pub struct DOVIMap<'core> {
    pub bl: Node<'core>,
    pub el: Node<'core>,
    pub rpus: Vec<DoviRpu>,
}

impl<'core> Filter<'core> for DOVIMap<'core> {
        ...
        match depth {
            ...
            9..=16 => {
                for cmp in 0..3_usize {
                    ...
                    for (bl_pixel, el_pixel, out_pixel) in izip!(bl_plane, el_plane, out_plane) {
